...
const ModalLayout = ({children}) => (
          <section className='fixed inset-0 flex justify-center md:mb-7 z-50'>
            <div className='h-[90%] w-[600px] p-8 bg-white rounded-lg mt-8 z-50 overflow-hidden flex flex-col md:h-[96%] md:w-[92%] md:left-4 md:-top-3 md:rounded-xl md:p-7'>
             {children}
            </div>
          </section>
)
  ...
  return (
    <>
      <section
        ...
        className='sticky-section bg-[#f1f1f1] p-14 md:w-full md:px-7 md:pt-[100px]'
      >
        <div className='mb-8'>
      ...
      {contact === 'booking' && (
        <ModalLayout>
          <div className='flex items-center mb-8 z-10'>
            <span className='bg-[#fd8e8e] h-[60px] w-[60px] rounded-full flex items-center justify-center mr-8 md:h-[50px] md:w-[50px] md:mr-4 flex-shrink-0'>
              <Image
                priority
                src='/images/emoji.png'
                className='brightness-110 contrast-100 h-[40px] w-[40px] md:h-[30px] md:w-[30px]'
            ...
            <p className='text-lg text-[#2e304b] font-semibold md:text-black '>
              I&apos;d like to book you in
            </p>
            <button onClick={() => setContact('')} className='md:ml-auto'>
              <svg
      ...
      {contact === 'quote' && (
        <ModalLayout>
          <div className='flex items-center mb-8 z-10'>
            <span className='bg-[#fde58e] h-[60px] w-[60px] rounded-full flex items-center justify-center mr-8 md:h-[50px] md:w-[50px] md:mr-4 flex-shrink-0'>
              <Image
                priority
                src='/images/emoji2.png'
                className='brightness-110 contrast-100 h-[40px] w-[40px] md:h-[30px] md:w-[30px]'
            ...
            <p className='text-lg text-[#2e304b] font-semibold md:text-black md:text-base'>
              I&apos;d like a quote for a project
            </p>
            <button onClick={() => setContact('')} className='md:ml-auto'>
              <svg
      ...
      {contact === 'hello' && (
        <ModalLayout>
          <div className='flex items-center mb-8 z-10'>
            <span className='bg-[#8efdb0] h-[60px] w-[60px] rounded-full flex items-center justify-center mr-8 md:h-[50px] md:w-[50px] md:mr-4 flex-shrink-0'>
              <Image
                priority
                src='/images/emoji3.png'
                className='brightness-110 contrast-100 h-[40px] w-[40px] md:h-[30px] md:w-[30px]'
