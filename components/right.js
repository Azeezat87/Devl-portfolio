 ...
 return (
   <section className='fixed h-screen w-1/2 bg-[#2e304b] text-[#fd8e8e] flex flex-col items-start p-[30px]'>
     <div className='relative'>
       <div
         className={[
           'absolute top-5 left-8 p-[30px] bg-white rounded-2xl',
           'overflow-hidden  transition-all duration-500',
           navbar
             ? 'h-[520px] w-[352px] -mt-6 -ml-7 rounded-[10px]'
             : 'h-12 w-12 rounded-[56px]',
         ].join(' ')}
       >
         <div className='flex gap-8 items-center mb-8'></div>

         <div className='h-[520px] w-[352px] overflow-hidden'>
           <span className='text-[#2e304b] text-[24px] font-semibold absolute top-[38px] right-24'>
             <p>Burger menu</p>
           </span>
           <div className='mt-14'>
             <ul>
       ...
       >
         <span
           ...
           className={
             'flex items-center justify-center rounded-[50%] w-[61px] h-[61px]'
           }
         >
           <Image
             priority
